...
public class C03_BasicAutention extends TestBaseEach {

       /*
           1- Bir class olusturun : BasicAuthentication
          2- https://testotomasyonu.com/basicauth sayfasina gidin
            sadece url gidersek UI ile kullanici adi ve sifre girmemiz gerekir

            bunun yerine kullandigimiz sirketin bize verecegi kullanici adi ve sifre
