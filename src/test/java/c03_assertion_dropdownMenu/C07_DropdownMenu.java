...
public class C07_DropdownMenu extends TestBaseEach {
    ...
    public void test01() {
        ...
        System.out.println("Value kullanarak secenek2 :" + select.getFirstSelectedOption().getText());

        // 3.Visible Text(Görünen metin) kullanarak Seçenek 1’i (Option 1) seçin ve yazdırın
        select.selectByVisibleText("Option 1");
        System.out.println("Visible text kullanma : " + select.getFirstSelectedOption().getText());

        // 4.Tüm dropdown değerleri(value) yazdırın
        // 1. yontem
        System.out.println("Tum dropdown menu :" + dDm.getText());

        // 2. yontem ResuableMethod'daki Listeye cevirme method'unu kullanarak
