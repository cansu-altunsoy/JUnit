...
public class C01_ReadExcel {
    ...
    public void test01() throws IOException {
        ...
        int actualUlkesayisi = sayfa1Obj.getLastRowNum() + 1 - 1;   // +1 method bize index getiriyor, satir sayisini bulmak icin +1 ekliyoruz
        int expectedUlkeSayisi = 190;                              // -1 basta baslik satiri oldugundan satir sayisindan 1 cikartarak ulke sayisini bulabiliriz
        ...
        int actualKullanilanUlkeSayisi = sayfa1Obj.getPhysicalNumberOfRows();
        int expectedKullanilanSatirSayisi = 191;

        Assertions.assertEquals(expectedKullanilanSatirSayisi, actualKullanilanUlkeSayisi);
